                ...
                builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        try {
                            ...
                            Toast.makeText(MainActivity3.this,"SMS Faild,please try again later.", Toast.LENGTH_LONG).show();
                        }
                ...
                builder.setNegativeButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (checkdeletedata==true)
                            Toast.makeText(MainActivity3.this,"Message Deleted", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(MainActivity3.this,"Message Not Deleted", Toast.LENGTH_LONG).show();
